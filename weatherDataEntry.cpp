...
countryType weatherDataEntry::intToCountryType(int index) {
    // Static map for integer-to-countryType conversion
    static const std::unordered_map<int, countryType> countryMap = {
        {1, countryType::AT}, {2, countryType::BE}, {3, countryType::BG},
        {4, countryType::CH}, {5, countryType::CZ}, {6, countryType::DE},
        {7, countryType::DK}, {8, countryType::EE}, {9, countryType::ES},
        {10, countryType::FI}, {11, countryType::FR}, {12, countryType::GB},
        {13, countryType::GR}, {14, countryType::HR}, {15, countryType::HU},
        {16, countryType::IE}, {17, countryType::IT}, {18, countryType::LT},
        {19, countryType::LU}, {20, countryType::LV}, {21, countryType::NL},
        {22, countryType::NO}, {23, countryType::PL}, {24, countryType::PT},
        {25, countryType::RO}, {26, countryType::SE}, {27, countryType::SI},
        {28, countryType::SK}
    };
...
std::string weatherDataEntry::countryToString(countryType &country)
{
